...
const ResetPasswordEmail = () => {
    ...
    return (
        <>
            ...
            <div className="login reset mx-auto my-10 border-2 border-gray-200 rounded-lg shadow-2xl flex flex-col justify-center items-center">
                <img src={mail} alt="" className='w-[20%] mx-auto my-2' />
