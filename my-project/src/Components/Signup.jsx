                ...
                <div className="login signup mx-auto my-14 border-2 border-gray-200 rounded-lg shadow-2xl">
                    ...
                    <div className="username flex flex-col text-[13px] gap-2 mx-6 my-6 mb-2">
                        ...
                        <div className="input flex items-center">
                            ...
                            {errors.username && <div className='text-red-500 relative z-10 top-[30px] w-full'>{errors.username.message}</div>}
                        </div>
                    </div>

                    <div className="passwords flex w-[100%] justify-between items-center">
                        <div className="password flex flex-col w-[16vw] text-[13px] gap-2 mx-6 my-6">
                            ...
                            <div className="input flex items-center justify-between">
                                ...
                                })} placeholder="Password" type={passwordShown ? 'text' : 'password'} className='p-2 px-8 border-2 border-gray-200 w-[40%] rounded-md absolute focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none ' />
                                {errors.password && <div className='text-red-500 relative z-10 top-[40px] w-full'>{errors.password.message}</div>}
                        ...
                        <div className="confirm-password flex flex-col w-[16vw] text-[13px] gap-2 mx-6 my-6">
                            ...
                            <div className="input flex items-center justify-between">
                                ...
                                {errors.confirmPassword && <div className='text-red-500 relative z-10 top-[40px] w-full'>{errors.confirmPassword.message}</div>}
                                <button onClick={togglePasswordVisibility} type="button" className="relative top-0  end-0 p-3.5 rounded-e-md">
                                    {passwordShown ? (
                                        <svg className="flex-shrink-0 size-3.5 text-gray-400 dark:text-neutral-600" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                            <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"></path>
