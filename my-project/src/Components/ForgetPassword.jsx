    ...
    return (
        <>
            ...
            <form action="" onSubmit={handleSubmit(onSubmit)}>
                <div className="login mx-auto flex flex-col justify-center my-14 border-2 border-gray-200 rounded-lg shadow-2xl">
                    <img src={forget} alt="" className='w-[20%] mx-auto my-4' />
                    <h1 className='text-center my-2'>Forget Password</h1>

                    <div className="email flex flex-col text-[14px] gap-2 mx-6 ">
                        <div className='font-medium text-center my-2 w-[90%] mx-auto' htmlFor="">Enter your Email and we'll send you a link to reset your password</div>
